...
<body style="width: 70%; margin: 0 auto 50px auto;" >
	...
	<div class="post_border">
		<div>
			<button class="single_round_btn" style="font-size: 14px;" disabled>날짜</button>
			<font style="color: #B0B0B0">&nbsp; > &nbsp;</font> <font style="font-size: 14px; font-weight: 600">
			<fmt:formatDate pattern="yyyy년 MM월 dd일" value="${now}"/></font>
		</div>
		<form name="form" method="POST" action="<c:url value='/member/diary/insert' />" enctype="multipart/form-data">
		<input type="hidden" name="commu_code" value="${post.commu_code}" readonly>
			<table>
				<tr>
					<td><input class="post_title" type="text" name="diary_title" required="required" value="${memo}"placeholder="제목을 입력해주세요.">  </td> 
				</tr>
				<tr><td><hr></td></tr>
				<tr>
					<td> 
			  ...
			  <input type="file" class="form-control" name="img_file" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
				...
				<tr>
					<td><!-- <input class="post_content" type="text" name="post_content" required="required" placeholder="내용을 입력하세요. ">  -->
						<textarea style="height:500px; "rows="" cols="" class="post_content" name="diary_content" required="required" placeholder="내용을 입력하세요. "></textarea></td>
				</tr>
				<tr>
