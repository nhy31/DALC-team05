...
<div class="row">
	...
	<div class="col-md-6">
		<h2 class="mb-3"> 회원 정보 수정 </h2>
			<form class="needs-validation" name="form" method="POST"  onsubmit="return checkAll()" action="<c:url value='/member/my/update.do' />" enctype="multipart/form-data" novalidate>
			<div class="row">
				...
				<div class="col-sm-12">
		              ...
		              <input type="text" class="form-control"  name="member_name" id="name" value="${me.member_name}" readonly>${member.member_name}
		        </div>
				<p/>
				
		        <div class="col-sm-12">
		        	<label for="name" class="form-label">이메일</label>
		         	  <input type="email" class="form-control"  name="member_id" id="email" readonly value="${me.member_id}">
		        </div>
				<p/>
			 	
			 	<div class="col-sm-12">
			 	<label for="name" class="form-label">닉네임</label>
	              <input readonly type="text"  value="${me.member_nickName}" class="form-control"  
	              name="member_nickName" id="neckName"  required>${member.member_nickName}
				...
				<p/>
	   			...
	   			<label for="name" class="form-label">휴대폰</label>
	    			<input type="text" name="member_phone"  class="form-control" id="phone" value="${me.member_phone}" required>${member.member_phone}
	  			</div>
			  	<p/>
			 
			  <div class="col-sm-12">
	   			 <label for="name" class="form-label">생년월일</label>
	    		  <input type="text" name="member_birth" readonly class="form-control" placeholder="생년월일" 
	    		  id="birthday" value="<fmt:formatDate pattern="yyyy년 MM월 dd일" value="${me.member_birth}"/>" required>${member.member_birth}
	  		  </div>
	  		  <p/>
			   ...
			   <div class="col-sm-12">
	    		 ...
	    		 <select class="form-select" aria-label="Default select example" name="sick_code">
	    		 	<option selected value="${me.sick_code}">${me.sick_name}</option>
			...
			<div class="col-sm-9">
			  ...
			  <input class="form-check-input" type="radio" name="member_sex" value="정보 미제공" id="flexRadioDefault1" 
			...
			<div class="form-check">
			  ...
			  <c:if test="${me.member_sex == '남성'}">checked</c:if>>
			...
			<div class="form-check">
			  ...
			  <c:if test="${me.member_sex == '여성'}">checked</c:if>>
			...
			<div class="input-group">
			  <input type="file" class="form-control" name="img_file" id="inputGroupFile04" 
			  aria-describedby="inputGroupFileAddon04" aria-label="Upload" value="">
			</div>
			</div>
			 </div>
			...
			<div class="mb-3 row">
		        ...
		        <div class="col-sm-9">
		              <input type="text" class="form-control"  name="member_allergy" id="allergy" 
		               value="${me.member_allergy}">
		         </div>
			</div>		
