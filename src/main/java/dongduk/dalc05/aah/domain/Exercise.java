...
public class Exercise {
	...
	private int exercise_length;
	private int sick_code;
	
	public Exercise() {}
	
	public Exercise(int exercise_code, String exercise_title, String exercise_channel, String exercise_thumb,
			String exercise_url, int exercise_length, int sick_code) {
		super();
	...
	public int getExercise_length() {
		return exercise_length;
	}

	public void setExercise_length(int exercise_length) {
		this.exercise_length = exercise_length;
	}
